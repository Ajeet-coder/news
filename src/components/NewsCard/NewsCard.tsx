...
const NewsCard = (props: any) => {
    ...
    return (
        <>
            ...
            <Card sx={{ maxWidth: 345, mt: 5 }} className='card-container' onClick={getCardDetails} >
                <CardHeader
                    avatar={
                ...
                <CardMedia
                    component="img"
                    height="194"
                    image={(null !== multimedia) ? multimedia[0].url : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4mtGoOLN5x15OeZknP7-9sNwaziiEp-tas_ObTrVm&s"}
                    alt="Paella dish"
                />
                <CardContent>
